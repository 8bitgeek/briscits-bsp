...
#define GPIO_AF_SDMMC1					GPIO_AF21_SDMMC1
...
#define	CARIBOU_PORTB_MODE		PIN_MODE(0,GPIO_Mode_IN) |			/* N/C 									*/	\
								...
								PIN_MODE(2,GPIO_Mode_IN) |			/* N/C 									*/	\
								PIN_MODE(3,GPIO_Mode_IN) |			/* N/C 									*/	\
								PIN_MODE(4,GPIO_Mode_OUT) |			/* GPIO: RS485_DIR						*/	\
								PIN_MODE(5,GPIO_Mode_IN) |			/* N/C									*/	\
								...
								PIN_MODE(15,GPIO_Mode_AF)			/* TIM8_CH3N							*/
...
#define	CARIBOU_PORTC_MODE		PIN_MODE(0,GPIO_Mode_IN) |			/* N/C 									*/	\
								...
								PIN_MODE(4,GPIO_Mode_IN) |			/* N/C									*/	\
								PIN_MODE(5,GPIO_Mode_IN) |			/* N/C									*/	\
								PIN_MODE(6,GPIO_Mode_AF) |			/* USART6_TX: RS485_TX					*/  \
								PIN_MODE(7,GPIO_Mode_AF) |			/* USART6_RX: RS485_RX					*/  \
								PIN_MODE(8,GPIO_Mode_IN) |			/* SDMMC1_D0: BB_SPI_MISO				*/  \
								PIN_MODE(9,GPIO_Mode_IN) |			/* SDMMC1_D1: X							*/	\
								PIN_MODE(10,GPIO_Mode_IN) |			/* SDMMC1_D2: X							*/	\
								PIN_MODE(11,GPIO_Mode_OUT) |		/* SDMMC1_D3: BB_SPI_NSS				*/	\
								PIN_MODE(12,GPIO_Mode_OUT) |		/* SDMMC1_CK: BB_SPI_SCK				*/	\
								PIN_MODE(13,GPIO_Mode_IN) | 		/* SDMMC_CD:  BB_SPI_CD					*/	\
								PIN_MODE(14,GPIO_Mode_IN) | 		/* N/C 									*/	\
								PIN_MODE(15,GPIO_Mode_IN)			/* N/C 									*/	\
...
#define	CARIBOU_PORTC_OSPEEDR	PIN_OSPEEDR(0,GPIO_Speed_2MHz) |	\
								...
								PIN_OSPEEDR(10,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(11,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(12,GPIO_Speed_50MHz) |	\
								PIN_OSPEEDR(13,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(14,GPIO_Speed_2MHz) |	\
								PIN_OSPEEDR(15,GPIO_Speed_2MHz)
...
#define	CARIBOU_PORTD_MODE		PIN_MODE(0,GPIO_Mode_AF) |			/* FMC_D2:     DQ2						*/	\
								...
								PIN_MODE(2,GPIO_Mode_OUT) |			/* SDMMC1_CMD: BB_SPI_MOSI   			*/	\
								PIN_MODE(3,GPIO_Mode_IN) |			/* N/C									*/	\
								PIN_MODE(4,GPIO_Mode_IN) |			/* N/C									*/	\
								PIN_MODE(5,GPIO_Mode_IN) |			/* N/C									*/	\
								PIN_MODE(6,GPIO_Mode_IN) |			/* N/C									*/	\
...
extern void hw_pin_set_afn	( GPIO_TypeDef* port, uint8_t pin, uint32_t afn);
extern void hw_pin_set_mode	( GPIO_TypeDef* port, uint8_t pin, uint32_t mode);
