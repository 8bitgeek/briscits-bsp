...
#define TIM8_BUS_HZ			(216000000)
#define TIM2_BUS_HZ			(54000000)
#define TIM14_BUS_HZ		(54000000)
#define TIM16_BUS_HZ		(108000000)
...
#else
#define TX_TIM				TIM8
#define TX_TIM_TRG_IRQn		TIM8_TRG_COM_TIM14_IRQn
#define	TX_TIM_CC_IRQn		TIM8_CC_IRQn
#define TX_TIM_UP_IRQn		TIM8_UP_TIM13_IRQn
#define TX_TIM_PWM_CHANNEL	PWM_CHANNEL_3
#define TX_TIM_BUS_HZ		TIM8_BUS_HZ								/* PWM Timer bus clock frequency */
#define TX_TIM_HZ			(TX_TIM_BUS_HZ/15)						/* PWM Timer counter frequency */
#define TX_TIM_PERIOD_HZ	(50000)									/* PWM Period Frequency */
#endif
